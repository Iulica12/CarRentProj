...
namespace CarRentProj.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            CarRentProj.Data.CarRentProjContext context)
        {
        ...
        { 
                returnUrl ??= Url.Content("~/"); ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
                var user = CreateUser();
